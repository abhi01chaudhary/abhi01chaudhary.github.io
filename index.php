...
<html lang="en">
<head>
    <title>Abhishek Chaudhary</title>
        ...
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark position-relative">
                ...
                <ul class="social-list list-inline mb-0">
                    <li class="list-inline-item"><a class="text-white" href="https://twitter.com/abhi01chaudhary"><i class="fab fa-twitter fa-fw"></i></a></li>
                    <li class="list-inline-item"><a class="text-white" href="https://www.linkedin.com/in/abhishek-chaudhary-504124105/"><i class="fab fa-linkedin-in fa-fw"></i></a></li>
                    ...
                    <li class="list-inline-item"><a class="text-white" href="https://bitbucket.org/abhi01chaudhary/"><i class="fab fa-bitbucket fa-fw"></i></a></li>
                </ul><!--//social-list-->
    ...
    <div class="header-intro theme-bg-primary text-white py-5">
        <div class="container">
            <div class="profile-teaser media flex-column flex-md-row">
                <img class="profile-image mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto" src="image/pic.jpg" alt="">
                <div class="media-body text-center text-md-left">
                    <div class="lead">Hello, my name is</div>
                    <h2 class="mt-0 display-4 font-weight-bold">Abhishek Chaudhary</h2>
                    <div class="bio mb-3">I'm a Web developer specialised in frontend and backend development for a medium as well as
                        complex scalable web apps. I write about web development on
                        <a class="link-on-bg" href="blog.html">my blog</a>
                        and regularly
                        <a class="link-on-bg" href="talks.html">speak</a>
                        at various web conferences and meetups. Want to know how I may help your project? Check out my project
                        <a class="link-on-bg" href="projects.html">case studies</a>
                        and <a class="link-on-bg" href="resume.html">resume</a>.
                    </div><!--//bio-->
...
<section class="skills-section section py-5">
    <div class="container">
        ...
        <div class="section-intro mx-auto text-center mb-5 text-secondary">I have more than 1.5 years of experience in building rich web applications for clients. Below is a quick overview of my main technical skill sets and tools I use. Want to find out more about my experience? <a href="resume.html">Check out my online resume</a>.</div>
            ...
            <div class="row">
                <div class="skills-block col-12 col-lg-4 mb-5 mb-3 mb-lg-0">
                    <div class="skills-block-inner bg-white shadow-sm py-4 px-5 position-relative">
                        ...
                        <div class="skills-icon-holder position-absolute d-inline-block rounded-circle text-center">
                            <img class="skills-icon" src="image/frontend.png" style="width: 40px;">
                        </div>
                        <ul class="skills-list list-unstyled text-secondary">
                            ...
                            <li class="mb-2"><i class="fas fa-check mr-2 text-primary"></i>Vue.js</li>
                        </ul>
                ...
                <div class="skills-block col-12 col-lg-4 mb-5 mb-3 mb-lg-0">
                    <div class="skills-block-inner bg-white shadow-sm py-4 px-5 position-relative">
                        ...
                        <div class="skills-icon-holder position-absolute d-inline-block rounded-circle text-center">
                            <img class="skills-icon" src="image/backend.png" style="width: 45px;">
                        </div>
                        <ul class="skills-list list-unstyled text-secondary">
                ...
                <div class="skills-block col-12 col-lg-4">
                    <div class="skills-block-inner bg-white shadow-sm py-4 px-5 position-relative">
                        ...
                        <div class="skills-icon-holder position-absolute d-inline-block rounded-circle text-center">
                            <img class="skills-icon" src="image/other-skills.png" style="width: 42px;">
                        </div>
                        <ul class="skills-list list-unstyled text-secondary">
...
<script type="text/javascript" src="js/flickity-custom.js"></script>
